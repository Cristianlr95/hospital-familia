...
- Avance estimado del proyecto Hospital - Familia: 95.9%.
- Marco de calculo: ver `docs/09-marco-avance-porcentual.md`.
- Delta de esta tarea: +0.4 puntos porcentuales por agregar configuracion basica de perfil para tutor/staff con endpoint autenticado, persistencia local actualizada y paneles conectados en dashboards.
