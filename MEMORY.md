...
- Avance estimado del proyecto Hospital - Familia: 99.2%.
- Marco de calculo: ver `docs/09-marco-avance-porcentual.md`.
- Delta de esta tarea: +0.7 puntos porcentuales por cerrar formalmente SMTP real como alcance post-beta, manteniendo recuperacion funcional y configuracion SMTP preparada.
...
- Pendiente principal para subir el avance: ejecutar validacion visual end-to-end formal en navegador interactivo.
